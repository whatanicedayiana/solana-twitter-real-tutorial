...
eval("const debug = typeof process === 'object' && ({\"VUE_APP_CLUSTER_URL\":\"https://api.devnet.solana.com\",\"NODE_ENV\":\"development\",\"BASE_URL\":\"/solana-twitter-real-tutorial/\"}) && ({\"VUE_APP_CLUSTER_URL\":\"https://api.devnet.solana.com\",\"NODE_ENV\":\"development\",\"BASE_URL\":\"/solana-twitter-real-tutorial/\"}).NODE_DEBUG && /\\bsemver\\b/i.test(({\"VUE_APP_CLUSTER_URL\":\"https://api.devnet.solana.com\",\"NODE_ENV\":\"development\",\"BASE_URL\":\"/solana-twitter-real-tutorial/\"}).NODE_DEBUG) ? (...args) => console.error('SEMVER', ...args) : () => {};\nmodule.exports = debug;\n\n//# sourceURL=webpack://app/./node_modules/@ledgerhq/devices/node_modules/semver/internal/debug.js?");
